...
public class DynamicRecordFactoryTest extends TestCase {
	...
	public void testGetName() {
		...
		Definition def1 = new Definition(Arrays.asList(INT_PRIMITIVE, INT_PRIMITIVE, STRING_OBJECT), new Order(2, false, false));
		Definition def2 = new Definition(Arrays.asList(INT_PRIMITIVE, INT_PRIMITIVE, INT_PRIMITIVE), new Order(2, false, false));
		Definition def3 = new Definition(Arrays.asList(INT_PRIMITIVE, INT_PRIMITIVE, INT_PRIMITIVE));
	...
	public void testNewRecord() {
		Definition def = new Definition(Arrays.asList(INT_PRIMITIVE, BOOLEAN_PRIMITIVE, BOOLEAN_WRAPPER, STRING_OBJECT, LONG_PRIMITIVE), new Order(0, true, false), new Order(1, true, false), new Order(2, false, true), new Order(3, true, false), new Order(4, true, false));
